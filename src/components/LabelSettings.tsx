...
const LabelSettings = () => {
  ...
  const handleDiagnosticPPLA = async () => {
    ...
    const cal = agentConfig.calibracao || { margem_c: 0, offset_r: -500, contraste: 12, fonte: 2, rotacao: 0 };
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <PPLAComparer
                ...
                currentCalibration={agentConfig.calibracao || { margem_c: 0, offset_r: -500, contraste: 12, fonte: 2, rotacao: 0 }}
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => setAgentConfigState({
                        ...agentConfig,
                        calibracao: {
                          ...agentConfig.calibracao || { margem_c: 0, offset_r: -500, contraste: 12, fonte: 2, rotacao: 0 },
