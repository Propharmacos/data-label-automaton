...
// Funções legadas de impressão (verificarImpressora, imprimirTeste, imprimirRotulos) removidas.
// O sistema agora usa exclusivamente o Agente HTTP (printAgentService.ts).
